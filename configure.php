...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('src/InvoiceServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        ...
        str_contains($file, determineSeparator('config/maakeenfactuur.php')) => rename($file, determineSeparator('./config/'.$packageSlugWithoutPrefix.'.php')),
